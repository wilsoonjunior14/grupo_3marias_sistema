...
class Client extends BaseModel
{
    ...
    static $dependentFields = ["name_dependent", "rg_dependent", 
    ...
    static $rules = [
        ...
        'rg' => 'required|min:13|max:14|regex:/^\d+$/',
        'rg_organ' => 'required|min:3|max:11|regex:/^([a-zA-Z]){3}\/([a-zA-Z]){2}$/',
        ...
        'nationality' => 'bail|required|max:255|min:3|regex:/^([a-zA-Z])+$/',
        'naturality' => 'bail|required|max:255|min:3|regex:/^([a-zA-Z])+$/',
        'ocupation' => 'string|bail|required|max:255|min:3',
        'email' => 'required|email:strict|max:100|min:3|string',
        'phone' => 'required|celular_com_ddd|max:20|min:10|string',
